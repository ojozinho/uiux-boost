...
const t = {
  en: {
    ...
    tagline: ["Pixel-perfect from Figma. Fully responsive.", "Screenshot-verified."],
    slop: "Zero AI slop.",
    cta: "Get Started",
    source: "Source Code",
    scroll: "SCROLL",
    whatItDoes: "WHAT IT DOES",
    notAnother: "Not another",
    ...
    matches375: "375px matches",
    matches1440: "1440px matches",
    screenshotLoop: "SCREENSHOT LOOP",
    buildCapture: "Build. Capture. Compare.",
    screenshotDesc: "Every viewport is screenshotted and compared against your Figma. Differences are caught, fixed, and re-verified.",
    pixelMatch: "98% pixel match",
    antiSlop: "ANTI-SLOP ENGINE",
    patternsBanned: "40+ AI patterns banned.",
    pipeline: "THE PIPELINE",
    howMagic: "How the",
    magicWorks: "magic works.",
    pipelineDesc: "Five phases, one loop. Every step is verified with real screenshots before moving forward.",
    steps: [
      { n: "01", label: "EXTRACT", desc: "Pull every token from Figma" },
      { n: "02", label: "IMPLEMENT", desc: "Build mobile-first with your stack" },
      { n: "03", label: "SCREENSHOT", desc: "Capture at every viewport" },
      { n: "04", label: "COMPARE", desc: "Pixel-diff against Figma source" },
      { n: "05", label: "FIX & SHIP", desc: "Correct and deploy" },
    ],
    quote: ['"If it looks like', 'AI made it,', 'we failed."'],
    quoteRule: "THE ONLY RULE THAT MATTERS",
    features: [
      { title: "Figma Extraction", desc: "Every font, color, spacing value and asset pulled automatically." },
      { title: "12+ Viewports", desc: "Stress-tested from 320px to 2560px. Fluid in between." },
      { title: "Mode B", desc: "No Figma? Guided design with live previews and real-time decisions." },
      { title: "Smart Animations", desc: "Scroll, hover, transitions — choreographed and staggered." },
    ],
    getStarted: "GET STARTED",
    oneCommand: "One command.",
    zeroDrama: "Zero drama.",
    installDesc: "Copy the skill folder to",
    andRun: "and run the command.",
    copy: "Copy",
    copied: "Copied!",
    downloadZip: "Download ZIP",
    viewGithub: "View on GitHub",
    cloneComment: "# clone the skill",
    runComment: "# open claude code and run",
    footer: "2026 UI/UX BOOST — built for humans who design",
    skillActive: "SKILL ACTIVE",
  },
  pt: {
    skill: "SKILL DO CLAUDE CODE",
    tagline: ["Pixel-perfect direto do Figma. Totalmente responsivo.", "Verificado por screenshot."],
    slop: "Zero AI slop.",
    cta: "Começar",
    source: "Código Fonte",
    scroll: "ROLAR",
    whatItDoes: "O QUE FAZ",
    notAnother: "Não é mais um",
    codeGen: "gerador de código.",
    terminal: "terminal",
    activated: "UI/UX BOOST ativado",
    sendLink: "manda o link.",
    extracting: "extraindo tokens...",
    typography: "tipografia:",
    building: "construindo 1/5...",
    matches375: "375px bateu",
    matches1440: "1440px bateu",
    screenshotLoop: "LOOP DE SCREENSHOT",
    buildCapture: "Constrói. Captura. Compara.",
    screenshotDesc: "Cada viewport é capturado e comparado com o Figma. Diferenças são corrigidas e re-verificadas.",
    pixelMatch: "98% match de pixel",
    antiSlop: "MOTOR ANTI-SLOP",
    patternsBanned: "40+ padrões de IA banidos.",
    pipeline: "O PIPELINE",
    howMagic: "Como a",
    magicWorks: "mágica funciona.",
    pipelineDesc: "Cinco fases, um loop. Cada etapa é verificada com screenshots reais antes de avançar.",
    steps: [
      { n: "01", label: "EXTRAIR", desc: "Puxa cada token do Figma" },
      { n: "02", label: "IMPLEMENTAR", desc: "Constrói mobile-first com seu stack" },
      { n: "03", label: "SCREENSHOT", desc: "Captura em cada viewport" },
      { n: "04", label: "COMPARAR", desc: "Diff de pixel contra o Figma" },
      { n: "05", label: "CORRIGIR", desc: "Corrige e faz deploy" },
    ],
    quote: ['"Se parece que', 'IA fez,', 'falhamos."'],
    quoteRule: "A ÚNICA REGRA QUE IMPORTA",
    features: [
      { title: "Extração do Figma", desc: "Cada fonte, cor, espaçamento e asset puxado automaticamente." },
      { title: "12+ Viewports", desc: "Testado de 320px a 2560px. Fluido entre eles." },
      { title: "Modo B", desc: "Sem Figma? Design guiado com previews ao vivo e decisões em tempo real." },
      { title: "Animações Smart", desc: "Scroll, hover, transições — coreografadas e escalonadas." },
    ],
    getStarted: "COMEÇAR",
    oneCommand: "Um comando.",
    zeroDrama: "Sem drama.",
    installDesc: "Copie a pasta da skill para",
    andRun: "e rode o comando.",
    copy: "Copiar",
    copied: "Copiado!",
    downloadZip: "Baixar ZIP",
    viewGithub: "Ver no GitHub",
    cloneComment: "# clonar a skill",
    runComment: "# abrir claude code e rodar",
    footer: "2026 UI/UX BOOST — feito pra humanos que projetam",
    skillActive: "SKILL ATIVA",
  },
} as const;
